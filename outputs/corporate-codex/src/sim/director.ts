...
const archetypes: EventArchetype[] = [
  {
    ...
    headlineTemplates: ["EXEX denies operational role in {cause}.", "EXEX repeats contractor-separation language after {cause}."],
    bodyTemplates: ["The company cited licensed operating scope and commercial confidentiality while declining to discuss contractor telemetry."],
  ...
  },
  {
    ...
    headlineTemplates: ["EXEX schedules investor call on corridor continuity and alternate routing.", "EXEX briefs holders on asset backing after {cause}."],
    bodyTemplates: ["Management emphasized legacy licenses, asset coverage, and non-contested extraction routes without conceding corridor liability."],
  ...
  },
  {
    ...
    institutionImpacts: { UNICOL: { publicTrust: 1 }, PSA: { publicTrust: 1 } },
    headlineTemplates: ["Regulatory review narrows HALCYON room on fatality-recognition delays.", "Class-action risk rises around HALCYON exclusion language."],
    bodyTemplates: ["Repeated delay language began pricing as litigation exposure rather than underwriting discipline."],
  ...
  },
  {
    ...
    headlineTemplates: ["Anchorpoint delays outbound cargo window after relay blackout.", "Anchorpoint hazard premiums rise as Proxima transfer window slips."],
    bodyTemplates: ["Transport desks cut delivery confidence while scarcity remained visible in the forward curve."],
  ...
  },
  {
    ...
    headlineTemplates: ["UNICOL access team verifies temporary civilian corridor clearance.", "UNICOL observers confirm limited access through {location}."],
    bodyTemplates: ["Verified access reduced ambiguity around settlement risk and capped immediate insurance upside."],
